...
const ClassifyCommandOutputSchema = z.object({
  category: z
    .enum(['SCHEDULE', 'NOTES', 'TASKS', 'MEETINGS', 'BRIEFING', 'HEALTH', 'MAIL', 'WEATHER', 'PROJECT', 'UNKNOWN'])
...
const prompt = ai.definePrompt({
  ...
  prompt: `You are a command classification expert. Your task is to classify the user's command into one of the following categories: SCHEDULE, NOTES, TASKS, MEETINGS, BRIEFING, HEALTH, MAIL, WEATHER, PROJECT.
